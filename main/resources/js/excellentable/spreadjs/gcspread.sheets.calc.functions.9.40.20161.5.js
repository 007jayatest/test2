        ...
        (function(Calc)
        {
            (function(Functions)
            {
                ...
                function fi_accrint(args)
                {
                    ...
                    {
                        return fi_accrint1(maturity, first_interest, settlement, rate, par, freq, basis, calc_method)
                    }
                    ...
                    for (var i = 0; i < freq; i++)
                    {
                        ...
                        interestDays[i] = __toOADate(new Date(nextYear, months[next], days[next])) - __toOADate(new Date(2001, months[i], days[i]))
                    }
                    var result = 0,
                        settlementDate = __toOADate(settlement);
                    while (issue_year < settlement_year || issue_year === settlement_year && issue_month < settlement_month || issue_year === settlement_year && issue_month === settlement_month && issue_day < settlement_day)
                    {
                        i = 0;
                        while (i < freq && (issue_month < months[i] || issue_month === months[i] && issue_day < days[i]) && (i === 0 || months[i] > months[i - 1]))
                        {
                            i++
                        }
                        ...
                        var currentDate = __toOADate(new Date(issue_year, issue_month, issue_day));
                        var nextDate = Math.min(__toOADate(new Date(nextYear, months[next], days[next])), settlementDate);
                ...
                function fi_accrint1(maturity, first_interest, settlement, rate, par, freq, basis, calc_method)
                {
                    var a,
                        d,
                        coefficient,
        ...
        (function(Calc)
        {
            (function(Functions)
            {
                ...
                function eg_row(args, context)
                {
                    ...
                    {
                        return new _CellInfoReference(reference.getSource(), reference.getRow(0), reference.getColumn(0), reference.getRowCount(0), 1, 0)
                    }
                ...
                function eg_column(args, context)
                {
                    ...
                    if (isArrayFormula && hasReference)
                    {
                        return new _CellInfoReference(reference.getSource(), reference.getRow(0), reference.getColumn(0), 1, reference.getColumnCount(0), 1)
                    }
                ...
                function eg_match(args)
                {
                    ...
                    var width = array.colCount;
                    var height = array.rowCount;
                    var matchType = Calc._Helper._argumentExists(args, 2) ? CalcConvert.I(args[2]) : 1;
                    if (width > 1 && height > 1)
                    {
                        return CalcErrorsNotAvailable
                    }
                ...
                function _appendA1Letter(sb, coord, relative)
                {
                    ...
                    for (; coord > 0; coord = parseInt(((coord - 1) / 26), 10))
                    {
                    ...
                    if (args[0] instanceof Calc.Reference)
                    {
                        ...
                        if (args.length == 2)
                        {
                            if (reference.getRangeCount() != 1 || arrayRowCount != 1 && arrayColumnCount != 1)
                                return CalcErrorsReference;
                            var index = Calc._Helper._argumentValid(args, 1) && CalcConvert.rI(args[1], intValue) ? intValue.value : 0;
                        ...
                        {
                            var row = Calc._Helper._argumentValid(args, 1) && CalcConvert.rI(args[1], intValue) ? intValue.value - 1 : -1;
                            var column = Calc._Helper._argumentValid(args, 2) && CalcConvert.rI(args[2], intValue) ? intValue.value - 1 : -1;
                            var area = Calc._Helper._argumentValid(args, 3) && CalcConvert.rI(args[3], intValue) ? intValue.value - 1 : 0;
                    ...
                    if (expression)
                    {
                        if ((expression.t === 8) || (expression.t === 9))
                        {
                            if (expression.t === 9)
                            {
                                ...
                                expression = source.getCustomName(expression.name)
                            }
                            else
                            {
                        ...
                        if (!expression || expression.t !== 0 && expression.t !== 1 && expression.t !== 2 && expression.t !== 3 && expression.t !== 16 && expression.t !== 17 && expression.t !== 26 && expression.t !== 25)
                        {
                            return CalcErrors.Reference
                        }
                        source = expression.source || context.source;
                        if (expression.t === 26 || expression.t === 25)
                        {
                        ...
                        if ((range.rowCount === 1 && range.columnCount === 1) && !context.acceptsReference)
                        {
        ...
        (function(Calc)
        {
            (function(Functions)
            {
                ...
                function st_averagea(args)
                {
                    ...
                    for (var i = 0; i < args.length; i++)
                    {
                        var array = CalcConvert.toArr(args[i], 0, true, true, false, true);
                        if (array.isError)
                        {
                            return array[0]
                        }
                ...
                function st_median(args)
                {
                    ...
                    {
                        var array = CalcConvert.toArr(args[k], 1, true, true, false, true);
                        if (array.isError)
                        {
                            return array[0]
                        }
                ...
                function st_mode(args)
                {
                    ...
                    {
                        var array = CalcConvert.toArr(args[argIndex], 1, true, true, false, true);
                        if (array.isError)
                        {
                            return array[0]
                        }
                ...
                function st_harmean(args)
                {
                    ...
                    for (var i = 0; i < args.length; i++)
                    {
                        array = CalcConvert.toArr(args[i], 1, true, true, false, true);
                        if (array.isError)
                        {
                            return array[0]
                        }
                ...
                function st_trimmean(args)
                {
                    ...
                    var array = CalcConvert.toArr(args[0], 1, true, true, false, true);
                    if (array.isError)
                    {
                        return array[0]
                    }
                ...
                function st_frequency(args)
                {
                    ...
                    var dataArray = CalcConvert.toArr(args[0], 1, false, true, false, true);
                    var binsArray = CalcConvert.toArr(args[1], 1, false, true, false, true);
                    var binsCount = 0,
                        i,
                        j,
                        element;
                ...
                function __dev2(args, stc)
                {
                    ...
                    for (var i = 0; i < args.length; i++)
                    {
                        array = CalcConvert.toArr(args[i], 0, true, true, false, true);
                        if (array.isError)
                        {
                            return array[0]
                        }
                ...
                function __getLogGamma(fZ)
                {
                    ...
                    if (fZ >= 1.0)
                        return Math_log(__getGammaHelper(fZ));
                    if (fZ >= 0.5)
                        return Math_log(__getGammaHelper(fZ + 1) / fZ);
                ...
                {
                    var array1 = CalcConvert.toArr(args[0], 1, true, true, false, true);
                    if (array1.isError)
                    {
                        return array1[0]
                    }
                    var array2 = CalcConvert.toArr(args[1], 1, true, true, false, true);
                    if (array2.isError)
                    {
                        return array2[0]
                    }
                ...
                function st_linest(args)
                {
                    ...
                    var knownX = [];
                    var knowXArray = helper._argumentExists(args, 1) ? args[1] : (function(rowCount, colCount)
                        {
                            var arr = [];
                            for (var row = 0; row < rowCount; row++)
                            {
                                ...
                                {
                                    arr[row][col] = row * colCount + col + 1
                                }
                            }
                            return new Calc._ConcreteArray(arr)
                        })(knownY.rowCount, knownY.colCount);
                    knownX = CalcConvert.toArr(knowXArray, 1, false, true, true);
                ...
                function st_percentileexc(args)
                {
                    ...
                    var list = CalcConvert.toArr(args[0], 1, true, true, false, true);
                    if (list.isError)
                    {
                        return list[0]
                    }
